...
:::{.callout-important}
Plot the dependence plot for *water* and *NaOH* of the Random Forest model and investigate.
:::

## Models with SHAP-based feature selection {#sec-shap-models}

:::{.callout-note}
Establish a feature selection mechanism with SHAP

- Initiate a model with all features
- Ranking the features with SHAP
- Two different approaches
  - Select subsets of 10%, 15%, 25%, 50%, 80% original set.
  - A loop of getting an 80% set of features until the performance does not go any higher
:::
